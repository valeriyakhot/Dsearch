...
class Download_service (httpService.Http_service, object):
    ...
    def service (self, params, object):
        if params['nodes'] != {}:
            ...
            Client = node_client.Node_client({str(node):params['nodes'][str(node)]})
...
class Search_service (httpService.Http_service, object):
    ...
    def service (self, params, object):
        if params['nodes'] !={}:
            ...
            out = Client.n_client(URI_SEARCH, pars_uri.get('Search')[0], self.url)
...
class Listener (httpService.Http_service, object) :
    ...
    def service(self, params, object):
        #print 'IM LISTENINGGGGGGGGGGGGGGGGG'
